...
public class AgendarImportacaoLojaHandler : IAgendarImportacaoLojaHandler
{
    private readonly IUnitOfWorkAccessor<IWorkContext> accessor;

    public AgendarImportacaoLojaHandler(IUnitOfWorkAccessor<IWorkContext> accessor)
    {
        this.accessor = accessor;
    }

    public async Task<Result<Loja>> HandleAsync(AgendarImportacaoLoja command, CancellationToken ct)
    {
