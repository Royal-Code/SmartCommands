...
--------|----------|----------|--------------------
RCCMD000 | Usage   | Error    | CMD001_Invalid_model_type, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd000)
RCCMD001 | Usage   | Error    | CMD001_Invalid_return_type, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd001)
RCCMD002 | Usage   | Error    | CMD002_HasProblems_method_not_found, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd002)
RCCMD003 | Usage   | Error    | CMD003_HasProblems_method_does_not_return_bool, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd003)
RCCMD004 | Usage   | Error    | CMD004_HasProblems_method_does_not_out_parameter_Problems, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd004)
RCCMD005 | Usage   | Error    | CMD005_Invalid_command_type, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd005)
RCCMD006 | Usage   | Error    | CMD006_ProduceNewEntity_requires_WithUnitOfWork, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd006)
RCCMD007 | Usage   | Error    | CMD007_ProduceNewEntity_must_return_Result_with_value, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd007)
RCCMD008 | Usage   | Error    | CMD008_CancellationToken_require_async_method, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd008)
RCCMD009 | Usage   | Error    | CMD009_EditEntity_requires_WithUnitOfWork, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd009)
RCCMD010 | Usage   | Error    | CMD010_EditEntity_requires_FirstParameter, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd010)
RCCMD011 | Usage   | Error    | CMD011_WithParameters_cant_be_entity_or_context, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd011)
RCCMD012 | Usage   | Warning  | CMD012_Only_one_MapApiHandlersAttribute, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd012)
RCCMD013 | Usage   | Error    | CMD013_Invalid_use_of_MapApiHandlersAttribute, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd013)
RCCMD014 | Usage   | Error    | CMD014_Id_property_not_found, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd014)
RCCMD015 | Usage   | Error    | CMD015_The_type_returned_by_the_command_was_not_found, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd015)
RCCMD016 | Usage   | Error    | CMD016_Property_not_found_for_the_object_returned, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd016)
RCCMD017 | Usage   | Error    | CMD017_Invalid_use_of_MapFindAttribute, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd017)
RCCMD018 | Usage   | Error    | CMD018_WithDbContextAttribute_cannot_be_used_with_WithUnitOfWorkAttribute, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd018)
RCCMD019 | Usage   | Error    | CMD019_WithWorkContextAttribute_cannot_be_used_with_WithUnitOfWorkAttribute, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd019)
RCCMD020 | Usage   | Error    | CMD020_WithWorkContextAttribute_cannot_be_used_with_WithDbContextAttribute, [Documentation](https://github.com/Royal-Code/SmartCommands/blob/main/src/.docs/diagnostics.md#rccmd020)
